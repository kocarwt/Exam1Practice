...
def run_test_problem1a():
    ...
    # ------------------------------------------------------------------
    expected = -0.9651  # This is APPROXIMATELY the correct answer.
    answer = problem1a(4, 20)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = -1.926  # This is APPROXIMATELY the correct answer.
    answer = problem1a(20, 50)
    print()
...
def run_test_problem1b():
    ...
    answer = problem1b(5, 8)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 13  # This is APPROXIMATELY the correct answer.
    answer = problem1b(6, 9)
    print()
    print('Test 4 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
